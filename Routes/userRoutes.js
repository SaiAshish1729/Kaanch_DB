const { refferedUser, updateUserDetails, userDetails, twitterAuth, topFiftyPointUsers, referalCalculations, generateInviteCodeForMyAccount } = require("../Controllers/userController.js");
...
router.put("/generate-invite-code", Authentication, generateInviteCodeForMyAccount);
